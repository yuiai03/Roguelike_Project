    ...
    public void ApplyBuff(PlayerData playerData, PlayerHealth playerHealth)
    {
        ...
        switch (buffType)
        {
            case BuffType.IncreaseDamage:
                ...
                Debug.Log($"Damage increased by {value}! New damage: {playerData.GetTotalDamage()}");
                break;
            ...
            case BuffType.IncreaseAttackSpeed:
                ...
                Debug.Log($"Attack speed increased by {value}s! New cooldown: {playerData.GetAttackCooldown()}");
                break;
            ...
            case BuffType.IncreaseMoveSpeed:
                ...
                Debug.Log($"Move speed increased by {value}! New speed: {playerData.GetEffectiveMoveSpeed()}");
                break;
